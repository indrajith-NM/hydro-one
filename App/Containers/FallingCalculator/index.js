...
export default class FallingCalculator extends Component {
  constructor(props) {
    super(props);
        ...
        <View style={styles.mainView}>
          <Header style={styles.headerBg}>
            ...
            <Body style={styles.body}>
              <Text style={styles.headerText}>Falling Clearance Calculator</Text>
            </Body>
          ...
          <View style={styles.MainLocationDateBG}>
              ...
              >
                ...
                <TextInput
                  ...
                  maxLength={50}
                  selectionColor="black"
                  placeholder="Surface Distance From Tree to Conductor"
                  placeholderTextColor="grey"
                  underlineColorAndroid="transparent"
                  autoCapitalize="none"
                  keyboardType="number-pad"
              ...
              >
                ...
                <TextInput
                  ...
                  maxLength={50}
                  selectionColor="black"
                  placeholder="Surface Angle at Conductor in Degrees"
                  placeholderTextColor="grey"
                  underlineColorAndroid="transparent"
                  autoCapitalize="none"
                  keyboardType="number-pad"
            ...
            >
              ...
              />
              <Text style={styles.SraechHotelText}>Falling Clearance Calculator</Text>
            </TouchableOpacity>
          </View>
        </View>
